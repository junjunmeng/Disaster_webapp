...
def load_data(messages_filepath, categories_filepath):
    '''
     Function: 
        load data from two csv file and then merge them together
     
     Args:
        messages_filepath(str): the file path of message csv file
        categories_filepath: the file path of categories.csv file
...
def clean_data(df):
    '''
     Function: 
      clean the data frame df
     
     Args:
        df (DataFrame): A dataframe loaded from the load_data, which include raw data of message and categories 
     
     Returns:
        df (DataFrame): A cleaned dataframe of message and Categories
    '''
    # split 'categories' into separate category columns
    categories = df['categories'].str.split(';', expand = True)
    
    # Select the first row of categories and convert it to column names
